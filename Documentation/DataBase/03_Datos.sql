...
insert into USUARIO values('1','1','CC','Nombre 1','Apellido 1','user1@unal.edu.co','user1','A');
insert into USUARIO values('2','2','CC','Nombre 2','Apellido 2','user2@unal.edu.co','user2','P');
insert into USUARIO values('3','3','CC','Nombre 3','Apellido 3','user3@unal.edu.co','user3','P');
insert into USUARIO values('4','4','CC','Nombre 4','Apellido 4','user4@unal.edu.co','user4','P');
insert into USUARIO values('5','5','CC','Nombre 5','Apellido 5','user5@unal.edu.co','user5','P');
insert into USUARIO values('6','6','CC','Nombre 6','Apellido 6','user6@unal.edu.co','user6','E');
insert into USUARIO values('7','7','CC','Nombre 7','Apellido 7','user7@unal.edu.co','user7','E');
insert into USUARIO values('8','8','CC','Nombre 8','Apellido 8','user8@unal.edu.co','user8','E');
insert into USUARIO values('9','9','CC','Nombre 9','Apellido 9','user9@unal.edu.co','user9','E');
insert into USUARIO values('10','10','CC','Nombre 10','Apellido 10','user10@unal.edu.co','user10','E');
