...
public class ConvocatoriaDAO extends CrudDAO<ConvocatoriaEntity> {
    ...
    */
	 ...
	 */
	public ConvocatoriaEntity getByID(String ID) {
        ...
        /**
         * Crea una convocatoria, para las fechas ingresarlas en el formato AAAA/MM/DD ("2015/09/20")
         * @param NOMBRE
         * @param DESCRIPCION
	...
	/**
         * Actualiza una convocatoria, para las fechas ingresarlas en el formato AAAA/MM/DD ("2015/09/20")
