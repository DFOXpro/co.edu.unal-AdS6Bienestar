...
import co.edu.UNal.ArquitecturaDeSoftware.Bienestar.Control.ServicioConsumo.*;
...
import co.edu.UNal.ArquitecturaDeSoftware.Bienestar.Control.ServicioConsumo.ListStudents;
...
//    }
    ...
    private static ListStudents bienestarESBOperation(int inputfal) {
        co.edu.UNal.ArquitecturaDeSoftware.Bienestar.Control.ServicioConsumo.BienestarESBService service = new co.edu.UNal.ArquitecturaDeSoftware.Bienestar.Control.ServicioConsumo.BienestarESBService();
        co.edu.UNal.ArquitecturaDeSoftware.Bienestar.Control.ServicioConsumo.BienestarESBPortType port = service.getBienestarESBPort();
